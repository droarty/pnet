...
function searchSelected(schid){
  startWait();
	...
	$.getScript("schoolStanineData0106.php?schId="+schid, callBk3);
};//end searchSelected...
var stanine={};
stanine.lines=[];
stanine.maxVal=40;
...
//		_dso.catEthList.displayGraph('junktest');
    ...
    $.getScript("schoolStanineData0106.php?setup=t", callBk);
	$('#searchBtn').click(function(){
		...
		$.post("schoolStanineData0106.php",$($(this)[0].form).serialize(), callBk2);
	});
	$("#advSearchBtn").click(function(){
	  startWait();
		var searchStr=$("#advsearchStr").val();
		var name=$("#advname").val();
		$.getScript("schoolStanineData0106.php?schId=q&searchStr="+searchStr+"&name="+name, callBk3);	
	});
	var ac=$("#feid_site");
	ac.autocomplete("schoolStanineData0106.php",{formatItem:function(item){
		return item[0];
