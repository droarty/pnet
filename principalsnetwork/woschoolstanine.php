...
function searchSelected(schid){
  startWait();
	...
	$.getScript("woschoolStanineData.php?schId="+schid, callBk3);
};//end searchSelected...
var stanine={};
stanine.lines=[];
stanine.maxVal=40;
...
//		_dso.catEthList.displayGraph('junktest');
    ...
    $.getScript("woschoolStanineData.php?setup=t", callBk);
	$('#searchBtn').click(function(){
		...
		$.post("woschoolStanineData.php",$($(this)[0].form).serialize(), callBk2);
	});
	$("#advSearchBtn").click(function(){
	  startWait();
		var searchStr=$("#advsearchStr").val();
		var name=$("#advname").val();
		$.getScript("woschoolStanineData.php?schId=q&searchStr="+searchStr+"&name="+name, callBk3);	
	});
	var ac=$("#feid_site");
	ac.autocomplete("woschoolStanineData.php",{formatItem:function(item){
		return item[0];
