...
select d.year, d.gradeLevel, d.year-d.gradeLevel+12 cohort,
  ...
  from (
   ...
   left join (select year, gradeLevel, label, below, meet, exceed from isbexchiwo_tests) s13 on (if(d.year between 2006 and 2012,s13.year=2113,s13.year=d.year+100) and s13.gradeLevel=d.gradeLevel and s13.label='PSAE Reading')
...
select d.year, d.gradeLevel, d.year-d.gradeLevel+12 cohort,
  ...
  from (
   ...
   left join (select year, gradeLevel, label, below, meet, exceed from isbexchiwo_tests) s13 on (if(d.year between 2006 and 2012,s13.year=2113,s13.year=d.year+100) and s13.gradeLevel=d.gradeLevel and s13.label='PSAE Mathematics')
group by d.year, d.gradeLevel
) g
union
select g.*,'8=8' q, 'PSAE' test,
...
select d.year, d.gradeLevel, d.year-d.gradeLevel+12 cohort,
  ...
  from (
   ...
   left join (select  year,gradeLevel, label, below, meet, exceed from isbexchiwo_tests) s13 on (if(d.year between 2006 and 2012,s13.year=2113,s13.year=d.year+100) and s13.gradeLevel=d.gradeLevel and s13.label='PSAE Science')
group by d.year, d.gradeLevel
) g
union
...
select d.year, d.gradeLevel, d.year-d.gradeLevel+12 cohort,
  ...
  from (
   ...
   left join (select  year,gradeLevel, label, below, meet, exceed from isbexchiwo_tests) s13 on (if(d.year between 2006 and 2012,s13.year=2113,s13.year=d.year+100) and s13.gradeLevel=d.gradeLevel and s13.label='ISAT Science')
group by d.year, d.gradeLevel
) g
union
select g.*,'8=8' q, 'ISAT' test,
...
select d.year, d.gradeLevel, d.year-d.gradeLevel+12 cohort,
  ...
  from (
   ...
   left join (select year, gradeLevel, label, below, meet, exceed from isbexchiwo_tests) s13 on (if(d.year between 2006 and 2012,s13.year=2113,s13.year=d.year+100) and s13.gradeLevel=d.gradeLevel and s13.label='ISAT Mathematics')
group by d.year, d.gradeLevel
) g
union
select g.*,'8=8' q, 'ISAT' test,
...
select d.year, d.gradeLevel,d.year-d.gradeLevel+12 cohort,
  ...
  from (
   ...
   left join (select year, gradeLevel, label, below, meet, exceed from isbexchiwo_tests) s13 on (if(d.year between 2006 and 2012,s13.year=2113,s13.year=d.year+100) and s13.gradeLevel=d.gradeLevel and s13.label='ISAT Reading')
group by d.year, d.gradeLevel
) g
) h 
